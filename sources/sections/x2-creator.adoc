...
because it is so different to other adaptor roles such
...
The model does not contain a representation of "et al.", although renderers may
...
<person>
  <surname>Twain</surname>
  <forename>Mark</forename>
  <variantname type="pseudonymOf">
    <surname>Clemens</surname>
    <forename>Samuel</forename>
    <forename>Langhorne</forename>
  </variantname>
  <variantname type="transliteration">
