...
The publisher is a subclass of creator (<<creator>>). <<iso690,clause 4.1>>
...
<<iso690,clause 4.6>> allows that distributors, issuers and sponsors 
...
(dates in other calendars, date corrections;
other subdivisions of the year;
...
for online publications. (Unlike in <<iso690>>, no distinction is made between
