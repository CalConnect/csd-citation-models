...
BibliographicItem/vocabid:: An item in a controlled vocabulary corresponding to the keyword
BibliographicItem/vocabid/type:: A label for the controlled vocabulary.
BibliographicItem/vocabid/uri:: A URI for the controlled vocabulary item.
BibliographicItem/vocabid/code:: The code for the controlled vocabulary item.
BibliographicItem/vocabid/term:: The term itself for the controlled vocabulary item.
